...
for quizNum in range(35):
    # Create the quiz key files.
    with open(f'capitalsquiz{quizNum + 1}s.txt', 'w') as quizFile:
    ...
    # with open(f'capitalsquiz_answers{quizNum + 1}s.txt', 'w') as answerKeyFile:
...
The filenames for the quizzes will be capitalsquiz<N>.txt, where <N>
    # TODO: Shuffle the order of the states.# TODO: Loop through all 50 states, making a question for each.
